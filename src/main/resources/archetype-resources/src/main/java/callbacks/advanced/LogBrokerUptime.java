...
public class LogBrokerUptime implements com.dcsquare.hivemq.spi.callback.schedule.ScheduledCallback {
    ...
    @Override
    public void execute() {
        final Optional<SYSTopicEntry> entry = sysTopicService.getEntry("${symbol_dollar}SYS/broker/uptime");
     ...
     * {@link com.dcsquare.hivemq.spi.callback.registry.CallbackRegistry${symbol_pound}reloadScheduledCallbackExpression(ScheduledCallback)}
